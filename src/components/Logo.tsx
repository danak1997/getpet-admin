import { chakra, Flex, HTMLChakraProps, Icon, Text, useColorModeValue, useToken } from '@chakra-ui/react';
...
export const Logo = (props: HTMLChakraProps<'svg'>) => {
  ...
  return (
    <Flex justifyContent="center" {...props}>
      <Icon as={FaPaw} color={color} w={10} h={10} alignSelf="center" />
      <Text fontSize="5xl" color={color} mr={5}>
        GetPet
      </Text>
